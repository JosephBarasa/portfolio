import { Link } from 'react-router-dom'; // Import Link for the contact link

const Footer = () => {
  return (
    <footer className="bg-black text-white py-8 px-4 text-center relative overflow-hidden">

      {/* Subtle background blur effects - Ensure z-index is low to not block anything */}
      ...
      {/* Footer content - Ensure z-index is higher than background */}
      <div className="relative z-10 max-w-6xl mx-auto"> {/* Added max-w-6xl mx-auto to constrain and center content */}

        {/* Top row: Social Icons (Left) and Contact Link (Right) */}
        <div className="flex justify-between items-center mb-6"> {/* flex for left/right alignment, mb for spacing below */}
          {/* Social Icons - Grouped at the far left */}
          <div className="flex space-x-6">
            {/* Instagram Icon */}
            <a
              href="https://www.instagram.com/_jose.ph.__?igsh=ZXh5ZWNndnQ1aHkx" // Replace with your actual Instagram URL
            ...
            {/* LinkedIn Icon */}
            <a
              href="https://www.linkedin.com/in/joseph-barasa-0270972a9/" // Replace with your actual LinkedIn URL
              aria-label="LinkedIn"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 text-white hover:bg-white hover:text-black transition-colors duration-300 cursor-pointer flex items-center justify-center"
          ...
          {/* Contact Link - At the far right with underline */}
          <Link
            to="/contact-me" // Ensure this matches your route for the Contact Me page
            className="text-gray-300 hover:text-white transition-colors duration-300 font-light text-base tracking-wide underline" // Added underline class
          >
            Contact Me
          </Link>
        </div>

        {/* Copyright and Location Text - Centered below the top row */}
        <div className="space-y-2"> {/* Grouped for vertical spacing */}
